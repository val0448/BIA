...
def plot_1d_slice(fn_name: str, fixed_coords: dict = None, axis=0, npoints=400):
    ...
    if fixed_coords is None:
        fixed_coords = {}
    # build a template point at center of bounds
    center = (lb + ub) / 2.0
    # override fixed coords if provided (and validate)
